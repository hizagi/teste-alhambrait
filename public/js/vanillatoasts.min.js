...
document.getElementById('vanillatoasts-container').appendChild(toast);VanillaToasts.toasts[toast.id]=toast;return toast}
VanillaToasts.setTimeout=function(toastid,val){if(VanillaToasts.toasts[toastid]){setTimeout(VanillaToasts.toasts[toastid].hide,val)}}}
